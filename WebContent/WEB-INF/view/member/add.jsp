...
<div id="content">
	...
	<form id="join_form">
		아이디 : <input type="text" name="memid" /><br> 이름 : <input
			type="text" name="name" /><br> 비밀번호 : <input type="text"
			name="password" /><br> 주민등록번호(ex.940501-2) : <input type="text"
			name="ssn" /> <br />
		<br /> 소속팀 <input type="radio" name="teamid" value="none"
			checked="checked" /> 없음 <input type="radio" name="teamid" value="A" />
		걍놀자 <input type="radio" name="teamid" value="B" /> 지은이네 <input
			type="radio" name="teamid" value="D" /> 왕거북이 <input type="radio"
			name="teamid" value="C" /> 코딩짱 <br />
		<br /> 프로젝트역할 <select name="roll" id="roll">
		...
		<br /> 수강과목 <input type="checkbox" name="subject" value="java"
			checked="checked" /> Java <input type="checkbox" name="subject"
			value="clang" /> C언어 <input type="checkbox" name="subject"
	...
	document.getElementById('join_form_btn')
			.addEventListener(
					...
					function() {
						...
						var x = service.nullChecker([ form.memid.value,
